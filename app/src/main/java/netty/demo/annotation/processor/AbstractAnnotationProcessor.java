 ...
 */
public abstract class AbstractAnnotationProcessor<A extends Annotation, M> extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(annotationClazz)) {
            try {
                ...
                M transformedModel = transformElementToModel(annotatedElement, annotatedElement.getAnnotation(annotationClazz));
